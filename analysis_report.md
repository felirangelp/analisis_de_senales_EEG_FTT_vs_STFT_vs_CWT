...
- **Tiempo de procesamiento**: 0.0159 segundos
...
- **Tiempo de procesamiento**: 0.0019 segundos
...
- **Tiempo de procesamiento**: 1.1012 segundos
...
- **CWT es 69.1x más lento que FFT**
- **CWT es 569.1x más lento que STFT**
...
### CWT (Continuous Wavelet Transform)
- **Tiempo de procesamiento**: 0.1210 segundos
- **Wavelet utilizada**: cmor
- **Escalas**: 50 (de 1.00 a 100.00)
- **Contenido en frecuencia identificado**:
  - Identifica contenido frecuencial con resolución temporal adaptativa
...
### Comparación de Rendimiento
- **CWT es 175.7x más lento que FFT**
- **CWT es 332.4x más lento que STFT**
