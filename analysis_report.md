...
- **Tiempo de procesamiento**: 0.0184 segundos
...
- **Tiempo de procesamiento**: 0.0024 segundos
...
- **Tiempo de procesamiento**: 1.0995 segundos
...
- **CWT es 59.8x más lento que FFT**
- **CWT es 466.3x más lento que STFT**
...
### CWT (Continuous Wavelet Transform)
- **Tiempo de procesamiento**: 0.1205 segundos
- **Wavelet utilizada**: cmor
- **Escalas**: 50 (de 1.00 a 100.00)
- **Contenido en frecuencia identificado**:
  - Identifica contenido frecuencial con resolución temporal adaptativa
...
### Comparación de Rendimiento
- **CWT es 209.1x más lento que FFT**
- **CWT es 352.4x más lento que STFT**
