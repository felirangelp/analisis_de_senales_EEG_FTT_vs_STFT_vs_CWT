...
- **Tiempo de procesamiento**: 0.0165 segundos
...
- **Tiempo de procesamiento**: 1.1081 segundos
...
- **CWT es 67.1x más lento que FFT**
- **CWT es 569.7x más lento que STFT**
...
### CWT (Continuous Wavelet Transform)
- **Tiempo de procesamiento**: 0.1198 segundos
- **Wavelet utilizada**: cmor
- **Escalas**: 50 (de 1.00 a 100.00)
- **Contenido en frecuencia identificado**:
  - Identifica contenido frecuencial con resolución temporal adaptativa
...
### Comparación de Rendimiento
- **CWT es 166.9x más lento que FFT**
- **CWT es 380.5x más lento que STFT**
